...
pizza = pd.read_csv(r"C:/Users/Administrator.DAI-PC2/Desktop/MachineLearning/Day3/pizza.csv")
print(pizza)
...
###############################################################################
insure =pd.read_csv(r"C:/Users/Administrator.DAI-PC2/Desktop/MachineLearning/Day3/Insure_auto.csv")
print(insure)
...
p = np.array([[x1_sum,x1_2_sum,x1_x2_sum],[x2_sum,x1_x2_sum,x2_2_sum],[1,x1_bar,x2_bar]])
