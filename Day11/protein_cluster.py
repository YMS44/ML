...
protein = pd.read_csv(r"C:\Users\Administrator.DAI-PC2\Desktop\MachineLearning\Day11\Protein.csv", index_col=0)
print(protein)
...
df_scaled = scaler.fit_transform(protein)
link = "ward"
